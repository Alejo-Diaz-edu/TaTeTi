...
--	type STD_LOGIC_2D is array (NATURAL RANGE <>, NATURAL RANGE <>) of STD_LOGIC;
	...
	SIGNAL sub_wire2	: STD_LOGIC_2D (16 DOWNTO 0, 23 DOWNTO 0);
	...
	SIGNAL sub_wire14	: STD_LOGIC_VECTOR (23 DOWNTO 0);
	SIGNAL sub_wire15	: STD_LOGIC_VECTOR (23 DOWNTO 0);
	SIGNAL sub_wire16	: STD_LOGIC_VECTOR (23 DOWNTO 0);
	SIGNAL sub_wire17	: STD_LOGIC_VECTOR (23 DOWNTO 0);
	SIGNAL sub_wire18	: STD_LOGIC_VECTOR (23 DOWNTO 0);

BEGIN
	sub_wire18    <= data0x(23 DOWNTO 0);
	sub_wire17    <= data1x(23 DOWNTO 0);
	sub_wire16    <= data2x(23 DOWNTO 0);
	sub_wire15    <= data3x(23 DOWNTO 0);
	sub_wire14    <= data4x(23 DOWNTO 0);
	sub_wire13    <= data5x(23 DOWNTO 0);
	sub_wire12    <= data6x(23 DOWNTO 0);
	sub_wire11    <= data7x(23 DOWNTO 0);
	sub_wire10    <= data8x(23 DOWNTO 0);
	sub_wire9    <= data9x(23 DOWNTO 0);
	sub_wire8    <= data10x(23 DOWNTO 0);
	sub_wire7    <= data11x(23 DOWNTO 0);
	sub_wire6    <= data12x(23 DOWNTO 0);
	sub_wire5    <= data13x(23 DOWNTO 0);
	sub_wire4    <= data14x(23 DOWNTO 0);
	sub_wire3    <= data15x(23 DOWNTO 0);
	result    <= sub_wire0(23 DOWNTO 0);
	sub_wire1    <= data16x(23 DOWNTO 0);
...
-- Retrieval info: CONNECT: @data 1 12 24 0 data12x 0 0 24 0
-- Retrieval info: CONNECT: @data 1 13 24 0 data13x 0 0 24 0
-- Retrieval info: CONNECT: @data 1 14 24 0 data14x 0 0 24 0
-- Retrieval info: CONNECT: @data 1 15 24 0 data15x 0 0 24 0
-- Retrieval info: CONNECT: @data 1 16 24 0 data16x 0 0 24 0
